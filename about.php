...
<body>
  ...
  <main>
     <h2>BoddyWork Gym is the best Gem in Hyderabad Now.</h2>
     <br>
     <h2>personal trainer ablable here</h2>

     <p>There are up to ten GYM trainer in this <b> BoddyWork Gym </b>. <br> <br>
       Some may call it a tagline,but for us, it’s a way of life. <br>
       It’s our Monday-thru-every-day mantra. An unfiltered philosophy 
 <br> that drives us to create a community and a gym for all. 
 <br> No judgments means room for everyone, regardless of shape, size, age,  <br>
  race, gender or fitness level. No matter your workout of choice, 
   <br> we want you to feel good while reaching your goals </p>


    <video autoplay muted loop id="myVideo" width="680" height="480">
